...
def genMnistZynet(dataWidth,sigmoidSize,weightIntSize,inputIntSize):
    ...
    model.add(zynet.layer("Dense",128,"hardmax"))
    weightArray = utils.genWeightArray('WeigntsAndBiasesCyclone.txt')
    biasArray = utils.genBiasArray('WeigntsAndBiasesCyclone.txt')
